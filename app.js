...
async function initFirebase() {
    try {
        ...
        document.getElementById('app').innerHTML = '<div style="text-align:center; padding: 50px;">Gagal memuat sistem keamanan</div>';
    }
}
...
function attachEvents() {
    ...
    document.getElementById('createAccountBtn').addEventListener('click', () => {
        ...
        const targetEmail = name + '@satria.dev';
        const isTaken = allUsers.some(u => u.email === targetEmail);
